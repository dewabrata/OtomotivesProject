...
public class Rincian_Pembayaran_Activity extends AppActivity {
    ...
    private void viewRincianPembayaran() {
        MessageMsg.showProsesBar(getActivity(), new Messagebox.DoubleRunnable() {
            ...
            public void run() {
                ...
                if (isJualPart) {
                    args.put("typeRincian", "RINCIAN JUAL PART");
                }
    ...
    private void loadDataRincianLayanan(Nson result) {
        ...
        find(R.id.tv_nama_pelanggan, TextView.class).setText(formatRp(result.get("NAMA_PELANGGAN").asString()));
        find(R.id.tv_no_ponsel, TextView.class).setText(formatRp(result.get("NO_PONSEL").asString()));
        find(R.id.tv_layanan, TextView.class).setText(formatRp(result.get("LAYANAN").asString()));
        find(R.id.tv_nopol, TextView.class).setText(formatRp(result.get("NOPOL").asString()));
        find(R.id.tv_frek, TextView.class).setText(formatRp(result.get("FREKWENSI").asString()));
        find(R.id.tv_totalLayanan, TextView.class).setText(formatRp(result.get("TOTAL_LAYANAN").asString()));
        find(R.id.tv_disc_layanan, TextView.class).setText(formatRp(result.get("DISC_LAYANAN").asString()));
        find(R.id.tv_disc_frekwensi, TextView.class).setText(formatRp(result.get("DISC_FREKWENSI").asString()));
        find(R.id.tv_totalPart, TextView.class).setText(formatRp(result.get("").asString()));
        find(R.id.tv_disc_part, TextView.class).setText(formatRp(result.get("DISC_PART").asString()));
        find(R.id.tv_harga_jasa_part, TextView.class).setText(formatRp(result.get("HARGA_JASA_PART").asString()));
        find(R.id.tv_disc_jasa_part, TextView.class).setText(formatRp(result.get("DISC_JASA_PART").asString()));
        find(R.id.tv_harga_jasa_lain, TextView.class).setText(formatRp(result.get("HARGA_JASA_LAIN").asString()));
        find(R.id.tv_disc_jasa_lain, TextView.class).setText(formatRp(result.get("DISC_JASA_LAIN").asString()));
        find(R.id.tv_harga_derek_transport, TextView.class).setText(formatRp(result.get("HARGA_DEREK").asString()));
        ...
        find(R.id.tv_dp, TextView.class).setText(formatRp(result.get("DP").asString()));
        find(R.id.tv_sisa_biaya, TextView.class).setText(formatRp(result.get("").asString()));
        find(R.id.tv_disc_spot, TextView.class).setText(formatRp(result.get("DISC_SPOT").asString()));
        find(R.id.tv_total_2, TextView.class).setText(formatRp(result.get("").asString()));
        find(R.id.et_ket_tambahan, EditText.class).setText(formatRp(result.get("KETERANGAN").asString()));
        find(R.id.et_catatan, EditText.class).setText(formatRp(result.get("CATATAN").asString()));
