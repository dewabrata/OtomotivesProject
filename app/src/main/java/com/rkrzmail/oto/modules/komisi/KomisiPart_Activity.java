...
public class KomisiPart_Activity extends AppActivity {
    ...
    private void initComponent() {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivityForResult(new Intent(getActivity(), AturKomisiPart_Activity.class), 10);
            }
        });
        ...
        recyclerView.setAdapter(new NikitaRecyclerAdapter(nListArray, R.layout.item_komisi_part) {
                    ...
                    public void onBindViewHolder(@NonNull NikitaViewHolder viewHolder, int position) {
                        ...
                        viewHolder.find(R.id.tv_posisi_komisiPart, TextView.class).setText(nListArray.get(position).get("POSISI").asString());
                        viewHolder.find(R.id.tv_namaPart_komisiPart, TextView.class).setText(nListArray.get(position).get("NAMA_PART").asString());
                        viewHolder.find(R.id.tv_discPart_komisiPart, TextView.class).setText(nListArray.get(position).get("KOMISI_JUAL").asString());
                        viewHolder.find(R.id.tv_discJasa_komisiPart, TextView.class).setText(nListArray.get(position).get("KOMISI_JASA").asString());
                    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        adapterSearchView(mSearchView, "search", "komisipart", "NAMA_PART", "");
