...
public class JasaLainBerkalaActivity extends AppActivity {
    ...
    private void initToolbar() {
        ...
        getSupportActionBar().setTitle("JASA BERKALA");
    ...
    private void reload(final String nama){
        MessageMsg.showProsesBar(getActivity(), new Messagebox.DoubleRunnable() {
            ...
            public void run() {
                ...
                args.put("nama", nama);
                result = Nson.readJson(InternetX.postHttpConnection(AppApplication.getBaseUrl("jasaberkala.php"),args)) ;
    ...
    private void initComponent() {
       ...
       /* //set data and list adapter
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.setHasFixedSize(true);
        recyclerView.setAdapter(new NikitaRecyclerAdapter(nListArray,R.layout.jasalainberkala_item){
            @Override
            public void onBindViewHolder(@NonNull NikitaViewHolder viewHolder, int position) {
                viewHolder.find(R.id.txtNamaJasaLain, TextView.class).setText(nListArray.get(position).get("NAMA").asString());
                ...
                viewHolder.find(R.id.txtWaktu, TextView.class).setText(nListArray.get(position).get("WAKTU").asString());

                viewHolder.find(R.id.txtKMSaatIni, TextView.class).setText("KM Saat Ini : " + nListArray.get(position).get("KM_SAAT_INI").asString());


                viewHolder.find(R.id.txtJasa, TextView.class).setText(nListArray.get(position).get("JASA").asString());
