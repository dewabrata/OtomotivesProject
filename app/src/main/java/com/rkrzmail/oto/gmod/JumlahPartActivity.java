...
public class JumlahPartActivity extends AppActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_jumlah_part);
        ...
        find(R.id.tblTambah).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private void tambah() {
        newProses(new Messagebox.DoubleRunnable() {
            ...
            public void run() {
                ...
                result = Nson.readJson(InternetX.postHttpConnection(AppApplication.getBaseUrl("jumlahpart.php"), args));
            }
