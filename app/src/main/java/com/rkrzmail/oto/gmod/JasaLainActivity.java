...
public class JasaLainActivity extends AppActivity {
    private View parent_view;

    private RecyclerView recyclerView;
    private AdapterListBasic mAdapter;

    final int REQUEST_DETAIL = 61;
    ...
    private void initComponent() {
       ...
       /* //set data and list adapter
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.setHasFixedSize(true);
        recyclerView.setAdapter(new NikitaRecyclerAdapter(nListArray,R.layout.jasalain_item){
            @Override
            public void onBindViewHolder(@NonNull NikitaViewHolder viewHolder, int position) {
                ...
                viewHolder.find(R.id.txtJasa, TextView.class).setText("Stock : " + nListArray.get(position).get("JASA").asString());
